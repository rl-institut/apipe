...
rule convert:
    ...
    """
    input: get_abs_dataset_path("raw", "osm") / "data" / "germany-240101.osm.pbf"
    output: DATASET_PATH / "germany-240101_filtered.osm.gpkg"
    params:
        temp_file=DATASET_PATH / "germany-240101_filtered.osm.pbf",
