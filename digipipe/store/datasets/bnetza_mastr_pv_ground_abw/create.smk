...
DATASET_PATH = get_abs_dataset_path("datasets", "bnetza_mastr_pv_ground_abw")
...
rule create:
    ...
    output:
        outfile=DATASET_PATH / "data" / "bnetza_mastr_pv_ground_abw.gpkg",
        outfile_agg=DATASET_PATH / "data" / "bnetza_mastr_pv_ground_agg_abw.gpkg"
    params:
