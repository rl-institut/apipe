...
rule convert:
    ...
    """
    input: get_abs_dataset_path("raw", "osm_openstreetmap") / "sachsen-anhalt-221003.osm.pbf"
    output: get_abs_dataset_path("preprocessed", "osm_filtered") / "sachsen-anhalt-221003.osm.gpkg"
