...
DATASET_PATH = get_abs_dataset_path("2_datasets", "bkg_vg250_districts_abw", data_dir=False)

rule bkg_vg250_districts_abw:
    """
    Extract districts of ABW region
    """
    input: get_abs_dataset_path("1_preprocessed", "bkg_vg250") / "bkg_vg250.gpkg"
    output: get_abs_dataset_path("2_datasets", "bkg_vg250_districts_abw") / "bkg_vg250_districts_abw.gpkg"
    params:
