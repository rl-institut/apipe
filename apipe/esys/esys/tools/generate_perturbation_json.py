...
# todo adapt for case study 2 if needed
...
# Filter für CapacityCost (ohne "commodity", "demand", "bus", "export",
# "import", "transmission")
capacity_cost_files = [
    f
    for f in file_list
...
# Filter für MarginalCost ("commodity", "transmission",
# "import", "export" enthalten)
marginal_cost_files = [
    f
    for f in file_list
