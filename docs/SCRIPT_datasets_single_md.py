...
def create_category_md_files():
                ...
                for file in files:
                    if file == "dataset.md":
                        ...
                        with open(dataset_md_file, "r") as dataset_file:
                            ...
                            md_file.write("\n")
                            md_file.write(
                                f"**Datensatz: `{category}/{os.path.basename(root)}`**\n\n"
                            )
                        ...
                        if os.path.exists(metadata_json_file):
                            ...
                            md_file.write('??? metadata "Metadaten"\n')
                            md_file.write("    ```json\n")
                            md_file.write(
                                "    "
    ...
    print("Category Markdown files generation completed.")


create_category_md_files()
